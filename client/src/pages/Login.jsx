...
const Login = () => {
  ...
  const handleForgotPassword = async () => {
    try {
      ...
      toast.success("Simulation: Password reset link dispatched!");
    } catch (error) {
      toast.error("Password reset dispatch failed.");
    }
  };
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-between p-8 sm:p-12 md:p-16 relative z-10 bg-zinc-950 border-r border-zinc-900">
        ...
        <div className="my-auto max-w-sm w-full mx-auto space-y-8">
          <div className="space-y-2">
            <h2 className="text-3xl font-black text-zinc-100 tracking-tight">Welcome to AssetFlow</h2>
            <p className="text-xs text-zinc-400 font-medium leading-relaxed">
              Sign in to your organization workspace to manage enterprise assets, resources, maintenance, bookings and operations from one intelligent ERP platform.
            </p>
          </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-zinc-900/60 border border-zinc-800 focus:border-blue-500/50 rounded-xl text-xs text-zinc-200 placeholder-zinc-650 focus:outline-none transition-all"
                  {...register("email", {
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[11px] text-blue-400 hover:text-blue-300 font-bold hover:underline transition-all"
                >
                  Forgot?
                </button>
              </div>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <Lock className="h-4 w-4 text-zinc-550" />
                </span>
                <input
                  type="password"
